...
class LinkedList:
    ...
    def add_to_head(self,value):
        ...
        if not self.head and not self.tail:
            ...
            # setting where head points is pointing to next
            self.head = new_node
    ...
    def add_to_tail(self, value):
        ...
        if not self.head:
            ...
            self.head = new_node
            self.tail = new_node
        # we have a non-empty list, add the new node to our new node
        else:
    ...
    def remove_head(self):
        ...
        # otherwise we have more than one element in out list
    ...
    def contains(self, value):
        ...
        while current:
            ...
            # if we've gotten here, then the node isn't in out list
        return False
